...
l1 = Listener(200)
twitterStream = Stream(auth,Listener(200))
...
#print("p = " + str(p))
#print("n = "+ str(n)
ppercent = (l1.p/1000)*100
npercent =(l1.n/1000)*100

pp = str(ppercent)
np = str(npercent)

print("like percent = " + pp)
print("dislike percent = " + np)
...
@app.route('/')
def main(pp,np):
    return render_template("polar.html",pp= pp,np= np)
