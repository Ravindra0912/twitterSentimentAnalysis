...
a=tweepy.OAuthHandler(password.consumer_key, password.consumer_secret)
a.set_access_token(password.access_token,password.access_token_secret)
a2=tweepy.API(a)
...
search_results = tweepy.Cursor(a2.search,q = "Python").items(5)
